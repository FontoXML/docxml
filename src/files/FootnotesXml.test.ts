...
describe('Footnotes', () => {
    ...
    it('Creates a node from XML', async () => {
        const testXml = `
            <w:footnotes ${ALL_NAMESPACE_DECLARATIONS}>
                <w:footnote w:id="0" w:type="continuationSeparator">
                    <w:p w14:paraId="73CEA7DB" w14:textId="1B999A9C" w:rsidR="00F02FC0" w:rsidRDefault="00F02FC0">
                        <w:pPr>
        ...
        `; 
        const testParagraph: Paragraph = new Paragraph({style: 'Normal'}, new Text({}, "Hello, this is the text of a paragraph."));
        footnotesXml.add(testParagraph, FootnoteType.separator);
        console.log(await footnotesXml.$$$toNode()); 
    })
}); 
